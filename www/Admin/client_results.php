...
// create short variable names
	...
	if(($searchtype == "branch_id") || ($searchtype == "client_id") || ($searchtype == "standing"))
        $sql = "SELECT * FROM Client WHERE " .$searchtype . " = " . $searchterm;
	elseif(($searchtype == "join_date>=") ||($searchtype == "dob>="))
	{
...
if(!empty($_POST['submitUpdate'])) {
	...
	echo "<p><a href='client_admin.php'>back to Client Admin.</a></p>";
        exit;
        $client_id = "";
...
if(!empty($_POST['submitInsert'])){
    ...
    if ( !isset($_POST['firstName_i']) || ( $_POST['firstName_i'] == "")
        || !isset($_POST['lastName_i']) || !isset($_POST['city_i']) || !isset($_POST['province_i']) 
	|| ( $_POST['lastName_i'] == "") || ( $_POST['city_i'] == "") || ( $_POST['province_i'] == "")
        || !isset($_POST['phone_i']) || !isset($_POST['email_i']) || !isset($_POST['dob_i'])
	|| ( $_POST['phone_i'] == "") || ( $_POST['email_i'] == "") || ( $_POST['dob_i'] == "")
        || !isset($_POST['join_date_i']) || !isset($_POST['category_i']) || !isset($_POST['branch_id_i'])
	|| ( $_POST['join_date_i'] == "") || ( $_POST['category_i'] == "") || ( $_POST['branch_id_i'] == "")
        || !isset($_POST['standing_i']) || ( $_POST['standing_i'] == "")) {
...
if(!empty($_POST['submitDelete'])){
    ...
    if (!isset($_POST['client_id_d']) || ($_POST['client_id_d'] == "")){
        echo "<p>You have not entered any of the required details.<br />
             Please go back and try again.</p>";
        exit;
    }
