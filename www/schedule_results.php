...
if(!empty($_POST['submitInsert'])){
    ...
    if (  !isset($_POST['hour_end_i']) || ($_POST['hour_end_i'] == "")
        || !isset($_POST['work_date_i']) || !isset($_POST['hour_begin_i']) || ($_POST['work_date_i'] == "") || ($_POST['hour_begin_i'] == "")
        || !isset($_POST['isHoliday_i']) || ($_POST['isHoliday_i'] == "") ) {
...
echo "<p><a href='schedule_admin.php'>back to Schedule Admin.</a></p>";
?>
</body>
</html>
