...
// create short variable names
	...
	if(($searchtype == "branch_id") || ($searchtype == "employee_id"))
        $sql = "SELECT * FROM Employee WHERE " .$searchtype . " = " . $searchterm;
	elseif(($searchtype == "start_date>=") || ($searchtype == "wage>="))
	{
...
if(!empty($_POST['submitInsert'])){
    ...
    if ( !isset($_POST['firstName_i'])
        || !isset($_POST['lastName_i']) || !isset($_POST['addr_i']) || ($_POST['lastName_i'] == "") || ($_POST['addr_i'] == "")
        || !isset($_POST['phone_i']) || !isset($_POST['email_i']) || ($_POST['phone_i'] == "") || ($_POST['email_i'] == "")
        || !isset($_POST['start_date_i']) || !isset($_POST['branch_id_i']) || ($_POST['start_date_i'] == "") || ($_POST['branch_id_i'] == "")
        || !isset($_POST['wage_i']) || ($_POST['wage_i'] == "")) {
...
if(!empty($_POST['submitDelete'])){
    ...
    $sql = "DELETE FROM Employee WHERE mployee_id = " . $employee_id;
...
echo "<p><a href='employee_admin.php'>back to Employee Admin.</a></p>";
?>
</body>
</html>
