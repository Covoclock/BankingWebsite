...
// create short variable names
	...
	if(($searchtype == "branch_id") || ($searchtype == "manager_id") || ($searchtype == "isHeadOffice"))
        $sql = "SELECT * FROM Branch WHERE " .$searchtype . " = " . $searchterm;
	elseif($searchtype == "opening_date>=") 
	{
    ...
    if(!empty($_POST['submitUpdate'])) {
        ...
        {
            echo "branch id is not set, error！";
	    echo "<p><a href='branch_admin.php'>back to Branch Admin.</a></p>";
            exit;
            $branch_id = "";
	    ...
	    //if ($isHeadOffice == "")  $isHeadOffice = 0;
    ...
    if(!empty($_POST['submitInsert'])){
        ...
        if ( !isset($_POST['province_i']) || ($_POST['province_i'] == "")
            || !isset($_POST['city_i']) || !isset($_POST['street_i']) || ($_POST['city_i'] == "") || ($_POST['street_i'] == "")
            || !isset($_POST['phone_i']) || !isset($_POST['fax_i']) || ($_POST['phone_i'] == "") || ($_POST['fax_i'] == "")
            || !isset($_POST['opening_date_i']) || !isset($_POST['manager_id_i']) || ($_POST['opening_date_i'] == "") || ($_POST['manager_id_i'] == "")
            || !isset($_POST['isHeadOffice_i']) || ($_POST['isHeadOffice_i'] == "")) {
    ...
    if(!empty($_POST['submitDelete'])){
        ...
        if (!isset($_POST['branch_id_d']) || ( $_POST['branch_id_d'] == "")){
            echo "<p>You have not entered any of the required details.<br />
             Please go back and try again.</p>";
	    echo "<p><a href='branch_admin.php'>back to Branch Admin.</a></p>";
            exit;
