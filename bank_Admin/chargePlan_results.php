...
if(!empty($_POST['submitUpdate'])) {
    ...
    if(!isset($_POST['chargePlan_id_u']))
    {
        $chargePlan_id = "";
...
if(!empty($_POST['submitInsert'])){
    ...
    if (  !isset($_POST['option_name_i'])
        || !isset($_POST['chargePlan_id_i'])
        || !isset($_POST['draw_limit_i']) || !isset($_POST['charge_value_i']) ) {
...
echo "<p><a href='chargePlan_admin.html'>back to ChargePlan Admin.</a></p>";
?>
</body>
</html>
