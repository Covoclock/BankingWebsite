...
if(!empty($_POST['submitUpdate'])) {
    ...
    if((!isset($_POST['service_id_u'])) || ($_POST['service_id_u'] == ""))
    {
        echo "service id not set, error";
	echo "<p><a href='service_admin.php'>back to Services Admin.</a></p>";
        exit;
        $service_id = "";
...
if(!empty($_POST['submitInsert'])){
	...
	|| ($_POST['service_name_i'] == "") || ($_POST['manager_id_i'] == "") || ($_POST['service_id_i'] == "")) {
...
if(!empty($_POST['submitDelete'])){
    ...
    if (!isset($_POST['service_id_d']) || ($_POST['service_id_d'] == "")){
        echo "<p>You have not entered any of the required details.<br />
             Please go back and try again.</p>";
        exit;
    }
