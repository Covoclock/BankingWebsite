...
/* Cote Des Neiges */
INSERT INTO Employee(employee_id, firstName, lastName, addr, start_date, salary, email, phone, branch_id)
VALUE( 'Kilian',  'karl', '453  Demo', '2003-11-29', 63333.22, 'zsadas@gmail.com', '450-555-5533', 4);
INSERT INTO Employee(employee_id, firstName, lastName, addr, start_date, salary, email, phone, branch_id)
VALUE( 'Karlito',  'kilimanjaro', '453  Demo', '2003-11-29', 63333.22, 'as3ds@gmail.com', '450-555-3355', 4);
...
/* Cote Des Neiges */
INSERT INTO Client(client_id, firstName, lastName, addr, dob, joining_date, email, phone,  branch_id)
VALUE('Tina', 'turner', '675 rue ontario', '1983-02-22', '2003-10-16', 'bgsdos@gmail.com', '450-222-9877', 5);
INSERT INTO Client(client_id, firstName, lastName, addr, dob, joining_date, email, phone,  branch_id)
VALUE('billy', 'Bush', '456 rue sherbrooke', '1995-03-11', '2003-12-22', 'asdae@gmail.com', '450-222-5675', 5);
...
/* Cote Des Neiges */
INSERT INTO Account(client_id, account_type, account_option, balance, credit_limit, interest_rate)
VALUE(5, 'saving', 'enhanced interest', 435440.11,  50000.00, 0.08);
INSERT INTO Account(client_id, account_type, account_option, balance, credit_limit, interest_rate)
VALUE(6, 'chequing', 'regular', 7655.23,  40000.00, 0.05);
